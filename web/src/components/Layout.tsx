...
export function Layout() {
  ...
  // /sessions-inbox (the Gmail-style prototype) owns its own search/filter bar in-page, so the global
  // date-range FilterBar would be redundant chrome — hide it there while keeping the rest of the shell.
  ...
  return (
    <div className={`app-shell${collapsed ? " rail-collapsed" : ""}`}>
      ...
      <div className={`content${isSessionsInbox ? " content--no-filterbar" : ""}`}>
