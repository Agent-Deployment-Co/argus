    ...
    sessions: [
      ...
      },
      {
        ...
        tasks: [
          ...
          {
            description: "Merge the duplicate contacts across HubSpot and Salesforce",
            outcome: "failure",
            frustration: "high",
            signals: ["no shared key", "repeated re-asks"],
            outcomeReason: "Without a shared id the two systems couldn't be safely reconciled.",
            evidence: "No reliable match key; Rachel stopped rather than risk bad merges.",
          },
        ],
      },
    ],
